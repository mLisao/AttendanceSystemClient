...
public class ScheduleTableView extends LinearLayout {
     ...
     * 配色数组
     */
    public static int colors[] = {R.drawable.select_label_1, R.drawable.select_label_2,
            R.drawable.select_label_3, R.drawable.select_label_4,
            R.drawable.select_label_5, R.drawable.select_label_6,
            R.drawable.select_label_7, R.drawable.select_label_8,
            R.drawable.select_label_9, R.drawable.select_label_10,
            R.drawable.select_label_11, R.drawable.select_label_12,
            R.drawable.select_label_13, R.drawable.select_label_14,
            R.drawable.select_label_15};
